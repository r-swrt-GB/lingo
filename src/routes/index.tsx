...
import { addLanguage, deleteLanguage, getLanguages, useStore } from "@/lib/storage";
...
function Home() {
  const languages = useStore(() => getLanguages());
                    ...
                    <div className="min-w-0">
                      ...
                      {!canPlay && (
                        <p className="text-[11px] text-muted-foreground mt-2">
                          Add at least 5 words to play
                        </p>
                      )}
                    </div>
                    <button
                      onClick={() => {
                        if (confirm(`Delete "${lang.name}"?`)) deleteLanguage(lang.id);
                      }}
            ...
            {adding ? (
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    type="submit"
                    className="flex-1 rounded-lg bg-primary text-primary-foreground text-sm font-medium py-2.5"
                  >
                    Add
                  </button>
                </div>
